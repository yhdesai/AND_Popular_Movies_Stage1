...
public class MainActivity2 extends AppCompatActivity implements TaskAdapter.ItemClickListener {
       ...
       /* FloatingActionButton fabButton = findViewById(R.id.fab);
        ...
        fabButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addTaskIntent = new Intent(MainActivity2.this, AddTaskActivity.class);
